...
// AFFICAHGE DE LA DATALIST DES PAYS
// datalist('api/v1/pays', '#datalist-pays', '#input_pays', '#pays_id');

// AFFICAHGE DE LA DATALIST DES PRIMES
datalist('api/v1/get_primes', '#datalist-primes', '#input_primes', '#prime_id');

// METHODE DE RECUPERATION DES VILLES PAR PAYS (VALABLE)
// $(document).on('keyup', '#input_pays', function() {
//     var pays_id = $('#pays_id').val();
//     // console.log("pays_id",pays_id);

//     $.ajax({
//         async: true,
//         url: '/api/v1/get_ville_by_pays/' + pays_id,
//         type: "GET",
//         dataType: 'json',
...
//             $.each(data.data.ville, function(i, d) {
//                 // $('#selectVille').append('<option value="' + d.id + '">' + d.libelle + '</option>');
//                 $('#selectVille').append('<option data-id="' + d.id + '" value="' + d.libelle + '">');
//             });
...
// RECUPERATION DE L'ID DE LA VILLE SELECTIONNER
// $(document).on("change", "#item", function() {
//     var val = $('#item').val();
//     // console.log("ok = ",val);
//     var id = $('#selectVille option').filter(function() {
...
// METHODE DE RECUPERATION DES COMMUNE PAR VILLES (VALABLE)
// $(document).on('keyup', '#item', function() {
//     var ville_id = $('#ville_id').val();
//     // console.log("ville_id",ville_id); 
//     $.ajax({
//         async: true,
//         url: '/api/v1/get_commune_by_ville/' + ville_id,
//         type: "GET",
//         dataType: 'json',
//         success: function(data) {
//             // console.log(data); 
...
//             $.each(data.data.commune, function(i, d) {
//                 $('#selectCommune').append('<option data-id="' + d.id + '" value="' + d.libelle + '">');
//             });
...
// RECUPERATION DE L'ID DE LA COMMUNE SELECTIONNER
// $(document).on("change", "#item_2", function() {
//     var val = $('#item_2').val();
//     // console.log("ok = ",val);
//     var id = $('#selectCommune option').filter(function() {
//         return this.value == val;
//     }).data('id');
//     var msg = id ? 'id=' + id : 'No Match';
//     // console.log("msg = ",msg); 
