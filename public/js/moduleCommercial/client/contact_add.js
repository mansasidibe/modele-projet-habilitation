...
function get_contact(datas) {
    ...
    $(datas).each(function(count, item) {
        ...
        var tab1 = [
                ...
                '<input type="radio" onclick="changeInterlocuteurbd(' + item.id + ')" style="border:none;" checked="checked" value="' + item.interlocuteur + '" name="tab[' + count + '][interlocuteur]" data="interlocuteur' + count + '" />',
                // item.interlocuteur == 1 ? '<input type="radio" onclick="changeInterlocuteurbd(' + item.id + ')" style="border:none;" checked value="' + item.interlocuteur + '" name="interlocuteur" data="interlocuteur" />' : '<input type="radio" onclick="changeInterlocuteurbd(' + item.id + ')" style="border:none;" value="' + item.interlocuteur + '" name="interlocuteur" data="interlocuteur" />',
                // item.interlocuteur == 1 ? '<input type="radio" onclick="changeInterlocuteurbd(' + item.id + ')" style="border:none;" checked value="' + item.interlocuteur + '" name="tab[' + count + '][interlocuteur]" data="interlocuteur' + count + '" />' : '<input type="radio" onclick="changeInterlocuteurbd(' + item.id + ')" style="border:none;" value="' + item.interlocuteur + '" name="tab[' + count + '][interlocuteur]" data="interlocuteur' + count + '" />',
...
localeJquery == "en" ? $('.btn_add').text('Add contact') : $('.btn_add').text('Ajouter contact');
...
$(document).on('click', '#edit', function() {
    ...
    console.log("valeur", $('input[id=idModif]').val());
    if ($('input[id=idModif]').val() >= 0) {
        localeJquery == "en" ? $('.btn_add').text('Edit contact') : $('.btn_add').text('Modifier contact');
        // localeJquery == "en" ? $('.btn_add').text('Add contact') : $('.btn_add').text('Ajouter contact');
    }
